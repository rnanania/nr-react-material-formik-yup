This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). The goal of this project is to demo some of the key things we need in any react application.
